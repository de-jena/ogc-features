 ...
 * <!-- end-user-doc -->
 * @see org.w3._2005.atom.util.AtomResourceImpl
 * @generated
 */
public class AtomResourceFactoryImpl extends ResourceFactoryImpl {
	 ...
	 * @generated
	 */
	public AtomResourceFactoryImpl() {
		super();
	}
	...
	public Resource createResource(URI uri) {
		Resource result = new AtomResourceImpl(uri);
		return result;
	}
	...
	public Map<String, Object> getServiceProperties() {
		...
		properties.put(EMFNamespaces.EMF_CONFIGURATOR_NAME, AtomPackage.eNAME);
		properties.put(EMFNamespaces.EMF_MODEL_FILE_EXT, "atom");
		properties.put(EMFNamespaces.EMF_MODEL_VERSION, "1.0");
		return properties;
	}

} //AtomResourceFactoryImpl
