...
public class AtomSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case AtomPackage.ATOM_PERSON_CONSTRUCT: {
				AtomPersonConstruct atomPersonConstruct = (AtomPersonConstruct)theEObject;
				T result = caseAtomPersonConstruct(atomPersonConstruct);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Person Construct</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Person Construct</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAtomPersonConstruct(AtomPersonConstruct object) {
		return null;
	}
