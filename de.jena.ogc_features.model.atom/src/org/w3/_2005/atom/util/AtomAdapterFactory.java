...
public class AtomAdapterFactory extends AdapterFactoryImpl {
	...
	protected AtomSwitch<Adapter> modelSwitch =
		new AtomSwitch<Adapter>() {
			@Override
			public Adapter caseAtomPersonConstruct(AtomPersonConstruct object) {
				return createAtomPersonConstructAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.w3._2005.atom.AtomPersonConstruct <em>Person Construct</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.w3._2005.atom.DocumentRoot <em>Document Root</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.w3._2005.atom.LinkType <em>Link Type</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
